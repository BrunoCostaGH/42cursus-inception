...
mariadb -e "ALTER USER 'root'@'localhost' IDENTIFIED BY '${SQL_ROOT_PASSWORD}';FLUSH PRIVILEGES;"
mariadb-admin -u root -p$SQL_ROOT_PASSWORD --wait-for-all-slaves shutdown
mysqld_safe
